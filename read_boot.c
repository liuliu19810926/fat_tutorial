...
// This structure is used to test attribute packed bug for mingw gcc 4.7.0
...
int main() {
    ...
    //=============
    // This code below is used to test attribute packed bug for mingw gcc 4.7.0
    printf("attribute packed test:\n");
    printf("Structure packing got %u offset, expected 3\r\n", (unsigned)((char*)&test.flags - (char*)&test));
    printf("\n");
    //=============
