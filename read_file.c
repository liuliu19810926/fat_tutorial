...
} __attribute((gcc_struct, __packed__)) PartitionTable;
...
} __attribute((gcc_struct, __packed__)) Fat16BootSector;
...
} __attribute((gcc_struct, __packed__)) Fat16Entry;
...
//	char filename[9] = "TEST    ", file_ext[4] = "TXT"; // initially pad with spaces
